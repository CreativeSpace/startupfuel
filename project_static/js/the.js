...
$(document).ready(function() {
  ...
  $('#twitter').html('<a href="http://twitter.com/share" class="twitter-share-button" data-text="{{ startup.twitter }} is getting started on Startup Dough. Let\'s make this happen!" data-count="horizontal" data-via="startupdough">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>');
});
